                ...
                <header id="header" class="site_header" role="banner">
					...
					<ul>
				     <li class="fb"><a target="_blank" href="https://www.facebook.com/mariam.maryouma.5249">Facebook</a></li>												<li class="lnkd"><a target="_blank" href="https://www.linkedin.com/in/sakly-ayoub-ba269391">Linkedin</a></li>												<li class="skp"><a target="_blank" href="skype:saklyayoub@live.com" class="skp">Skype</a></li>
                             <li><a target="_blank" href="http://127.0.0.1/cv_maker/login.php" style="width:auto;">login</a></li>
					</ul>
				</div>
			        </header>
	    <div id="main" >
		...
		<div id="content" class="site_content" role="main">
			...
			<section id="profile" class="section profile_section first odd">
				<div class="section_header profile_section_header opened">
					...
					<script src="http://127.0.0.1/zied/cv_maker/\js\post.js"> </script>					
                        <div id="profile_user">
               <div id="profile_photo"><img src="http://127.0.0.1/cv/img/index.png" alt="zied tuihri" /></div>
              <div id="profile_name_area">
                                <div id="profile_name">
                                                <h1 id="profile_title"><span class="firstname"><?php 
																			...
																			<span id="T7" class="td" ><?php echo $json[0]['T7']; ?> </span></h4>
                                            </div>  
                            </div>
                        </div>                 
						<div id="profile_data">                                        
